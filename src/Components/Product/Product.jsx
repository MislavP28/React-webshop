    ...
    return(
        ...
        <div class="ROGfalchion">
            ...
            <div class="demodiv">
                ...
                <a href=""><a href=""><span><img class="klikkup" src="Slike/ikone/minecart.svg" alt="klik za kupnju"></span></a></a>
            </div>
        </div>
        <div class="rx7900xtx" >
            <div>
            ...
            <div class="demodiv">
                <span></span><h3>RX 7900 XTX</h3></span>
                <span>999,99 EUR</span>
                <a href=""><span><img class="klikkup" src="Slike/ikone/minecart.svg" alt="klik za kupnju"></span></a>
            </div>
        </div>
        <div class="rtx4090" >
            <div>
